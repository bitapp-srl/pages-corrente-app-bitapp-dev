jQuery(document).ready(function($) {
    ...
    var areeRilascioLayer = new google.maps.KmlLayer({
        //url: 'https://dev.bitapp.it/corrente/assets/kml/corrente_2021.kml',
        url: 'https://corrente.app/assets/kml/corrente_2021.kml',
    ...
    var parcheggiLayer = new google.maps.KmlLayer({
        url: 'https://corrente.bo.it/assets/kml/Nparcheggi-carsharing.kmz',
        suppressInfoWindows: true,
        preserveViewport: true,
        map: null
    });
    ...
    var zoneNoTransitoLayer = new google.maps.KmlLayer({
        url: 'https://corrente.app/assets/kml/zone_rosse_2021.kml',
        //url: 'https://dev.bitapp.it/corrente/assets/kml/zone_rosse_2021.kml',
        suppressInfoWindows: true,
        preserveViewport: true,
        map: null
    });
